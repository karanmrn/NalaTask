select attempt_date, provider_name,
    ...
    avg(completion_seconds_proxy) as avg_completion_seconds_proxy,
    avg(failure_seconds_proxy) as avg_failure_seconds_proxy,
    ...
    sum(case when completed_attempt_count = 1 and completion_seconds_proxy is null then 1 else 0 end) as completed_duration_unknown
